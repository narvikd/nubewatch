// Package discover is responsible for handling the discovery of nubewatch nodes.
package discover
...
func ServeAndBlock(nodeID string, port int) {
	...
	info := []string{"nubewatch Discover"}
...
// query sends an mDNS query to discover nubewatch nodes and returns a list of their hosts.
