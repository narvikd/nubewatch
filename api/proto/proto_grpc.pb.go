...
type ServiceClient interface {
	ExecuteOnLeader(ctx context.Context, in *ExecuteOnLeaderMsg, opts ...grpc.CallOption) (*ExecuteOnLeaderMsg, error)
	...
	RegisterServer(ctx context.Context, in *RegisterServerReq, opts ...grpc.CallOption) (*RegisterServerRes, error)
...
func (c *serviceClient) ExecuteOnLeader(ctx context.Context, in *ExecuteOnLeaderMsg, opts ...grpc.CallOption) (*ExecuteOnLeaderMsg, error) {
	out := new(ExecuteOnLeaderMsg)
...
func (c *serviceClient) RegisterServer(ctx context.Context, in *RegisterServerReq, opts ...grpc.CallOption) (*RegisterServerRes, error) {
	out := new(RegisterServerRes)
	err := c.cc.Invoke(ctx, "/proto.Service/RegisterServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) GetServers(ctx context.Context, in *GetServersReq, opts ...grpc.CallOption) (*GetServersRes, error) {
	out := new(GetServersRes)
	err := c.cc.Invoke(ctx, "/proto.Service/GetServers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceServer interface {
	ExecuteOnLeader(context.Context, *ExecuteOnLeaderMsg) (*ExecuteOnLeaderMsg, error)
	...
	RegisterServer(context.Context, *RegisterServerReq) (*RegisterServerRes, error)
...
func (UnimplementedServiceServer) ExecuteOnLeader(context.Context, *ExecuteOnLeaderMsg) (*ExecuteOnLeaderMsg, error) {
...
func (UnimplementedServiceServer) RegisterServer(context.Context, *RegisterServerReq) (*RegisterServerRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterServer not implemented")
}
func (UnimplementedServiceServer) GetServers(context.Context, *GetServersReq) (*GetServersRes, error) {
...
func _Service_ExecuteOnLeader_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).ExecuteOnLeader(ctx, req.(*ExecuteOnLeaderMsg))
	}
...
func _Service_RegisterServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterServerReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).RegisterServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Service/RegisterServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).RegisterServer(ctx, req.(*RegisterServerReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Service_GetServers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Service/GetServers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).GetServers(ctx, req.(*GetServersReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Service_RegisterServer_Handler,
		},
		{
